  ...
  items: [
    {
      ...
      description:
        'Apple iOS, экран 6.1" IPS (828x1792), Apple A13 Bionic, ОЗУ 4 ГБ, флэш-память 128 ГБ, камера 12 Мп, аккумулятор 3046 мАч, 1 SIM',
      urlToImg:
        "https://content2.onliner.by/catalog/device/header/17bd189a9b6118a4d159047076f80c2d.jpeg",
    },
    {
      id: uuidv4(),
      ...
      description:
        'Apple iOS, экран 6.1" IPS (828x1792), Apple A13 Bionic, ОЗУ 4 ГБ, флэш-память 128 ГБ, камера 12 Мп, аккумулятор 3046 мАч, 1 SIM',
      urlToImg:
        "https://content2.onliner.by/catalog/device/header/3270c142a950a37f1242f0d419a318f4.jpeg",
    },
    {
      id: uuidv4(),
      ...
      description:
        'Apple iOS, экран 6.1" IPS (828x1792), Apple A13 Bionic, ОЗУ 4 ГБ, флэш-память 128 ГБ, камера 12 Мп, аккумулятор 3046 мАч, 1 SIM',
      urlToImg:
        "https://content2.onliner.by/catalog/device/header/383d93184d95011c8aeb70bf3cfb8140.jpeg",
    },
    {
      id: uuidv4(),
      ...
      description:
        'Apple iOS, экран 6.1" IPS (828x1792), Apple A13 Bionic, ОЗУ 4 ГБ, флэш-память 128 ГБ, камера 12 Мп, аккумулятор 3046 мАч, 1 SIM',
      urlToImg:
        "https://content2.onliner.by/catalog/device/header/6f5ffba85b044dcceb380498ac02c597.jpeg",
    },
    {
      id: uuidv4(),
    ...
    },
    {
      ...
      description:
        'Apple iOS, экран 6.1" OLED (1170x2532), Apple A14 Bionic, флэш-память 128 ГБ, камера 12 Мп, аккумулятор 2815 мАч, 1 SIM',
      urlToImg:
        "https://content2.onliner.by/catalog/device/header/e4d9b3df1aefa23c1193f230b958bae0.jpeg",
    },
    {
      id: uuidv4(),
    ...
    },
    {
      ...
      description:
        'Apple iOS, экран 6.1" OLED (1170x2532), Apple A14 Bionic, флэш-память 128 ГБ, камера 12 Мп, аккумулятор 2815 мАч, 1 SIM',
      urlToImg:
        "https://content2.onliner.by/catalog/device/header/4f68c0a86e8254fe09df404e98d56e53.jpeg",
    },
    {
      id: uuidv4(),
      ...
      description:
        'Apple iOS, экран 6.1" OLED (1170x2532), Apple A14 Bionic, флэш-память 128 ГБ, камера 12 Мп, аккумулятор 2815 мАч, 1 SIM',
      urlToImg:
        "https://content2.onliner.by/catalog/device/header/3f38cc72915132d668c7b3d488e7ab4d.jpeg",
    },
    {
      id: uuidv4(),
      title: "Смартфон Apple iPhone 12 64GB (синий)",
      description:
        'Apple iOS, экран 6.1" OLED (1170x2532), Apple A14 Bionic, флэш-память 64 ГБ, камера 12 Мп, аккумулятор 2815 мАч, 1 SIM',
      urlToImg:
        "https://content2.onliner.by/catalog/device/header/e4d9b3df1aefa23c1193f230b958bae0.jpeg",
    },
  ],
