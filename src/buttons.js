...
const Buttons = (props) => {
    ...
    function searchNews (event) {
        ...
        const newFilter = [...news].filter((value) => {return value.title.toLowerCase().includes(searchNew.toLowerCase())})
    ...
    return(
        <div className='btn_news' style={btnStyle}>
            ...
            <button className='home' onClick={() => {setNews(props.info)}}>Home</button>
            </div>
            <input className='input'  type = 'text' placeholder='Input News' onChange={searchNews}></input>
