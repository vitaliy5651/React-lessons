...
class Buttons extends React.Component{
    ...
    searchNews = (event) => {
        ...
        const newFilter = [...this.state.news].filter((value) => {return value.title.toLowerCase().includes(searchNew.toLowerCase())})
...
render(){
    return(
        <div className='btn_news' style={btnStyle}>
            ...
            <button className='home' onClick={() => {this.setState({news: this.props.info})}}>Home</button>
            </div>
