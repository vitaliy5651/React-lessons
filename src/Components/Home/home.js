...
return (
    <div className="Home" style={home}>
        ...
        <div className="home_description">Сверху ты можешь посмотреть на примерные модели ну или по крайней мере увидеть как повышаются размеры этого пластика и при этом цена взлетает до небес) Наслаждайся:)</div>
    </div>
)
}
